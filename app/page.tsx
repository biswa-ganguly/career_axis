...
<header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-neutral-800 dark:border-neutral-700">
  ...
  >
    <div className="flex items-center justify-between w-full sm:w-auto">
      <div>
        <Image src={'/logo2.png'} alt="logo" width={200} height={70} />
      </div>
    </div>
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end sm:ps-7 cursor-pointer gap-x-4">
        {/* Welcome message + UserButton aligned side by side */}
        {user && (
          <>
            <span className="text-gray-700 dark:text-neutral-300 font-medium text-base whitespace-nowrap">
